...
import { ShoppingBag, Package, MapPin, Calendar, ArrowRight, User as UserIcon, Coins, History as HistoryIcon, X, Loader2, AlertCircle, Box, Clock, CheckCircle, Truck, ChevronDown } from "lucide-react"
                ...
                {orders.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {orders.map((order: any) => {
                            ...
                            return (
                                <div key={order.id} className="glass-card border-white/10 overflow-hidden hover:border-[hsl(var(--accent-primary))]/30 transition-all">
