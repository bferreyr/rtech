...
import { X, Tag, Package, DollarSign, Building2, Layers, FileText, ChevronRight } from 'lucide-react';
...
export function ProductExtranetModal({ product, onClose, globalMarkup, exchangeRate }: Props) {
                ...
                <div className="extranet-modal-body">
                    ...
                    <div className="extranet-price-grid">
                        <div className="extranet-price-card extranet-price-usd">
                            ...
                            <div className="extranet-price-sub">
                                Base: {formatUSD(baseUsd)} + {globalMarkup}% markup
                            </div>
                        </div>
